...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactDebugTool = __webpack_require__(17);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactInvalidSetStateWarningDevTool = __webpack_require__(18);
	var warning = __webpack_require__(9);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = function (_React$Component) {
	  ...
	  _createClass(App, [{
	    key: 'handleClass',
	    value: function handleClass(course) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SideBar = function SideBar(_ref) {
	  ...
	  var handleHome = _ref.handleHome;

	  var classes = courses.map(function (course) {
	    return _react2.default.createElement(
	      "div",
	      { onClick: function onClick() {
	          return handleClass(course);
	        } },
	      course.name
	    );
	  });
	...
	SideBar.propTypes = {
	  courses: _react2.default.PropTypes.array,
	  handleClass: _react2.default.PropTypes.func,
	  handleHome: _react2.default.PropTypes.func
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Main = function Main(_ref) {
	  ...
	  var courseChanged = _ref.courseChanged;
	  ...
	  if (isHome) {
	    ...
	    view = _react2.default.createElement(
	      ...
	      _react2.default.createElement(_Info2.default, { currentCourse: currentCourse, courseChanged: courseChanged })
	    );
	  }
	  return view;
	};
	...
	Main.propTypes = {
	  isHome: _react2.default.PropTypes.bool,
	  currentCourse: _react2.default.PropTypes.object,
	  courseChanged: _react2.default.PropTypes.bool
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	Timeline.propTypes = {
	  data: _react2.default.PropTypes.bool
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AllStudentsTab = __webpack_require__(37);

	var _AllStudentsTab2 = _interopRequireDefault(_AllStudentsTab);

	var _AssignmentsTab = __webpack_require__(38);

	var _AssignmentsTab2 = _interopRequireDefault(_AssignmentsTab);

	var _Student = __webpack_require__(39);
	...
	var Info = function (_React$Component) {
	  ...
	  _createClass(Info, [{
	    ...
	    key: 'handleAllStudentsTab',
	    value: function handleAllStudentsTab() {
	      this.setState({ tabView: 'Students' });
	    }
	  }, {
	    key: 'handleStudent',
	    value: function handleStudent(student) {
	      this.setState({ tabView: 'Student' });
	      this.setState({ currentStudent: student });
	    }
	  }, {
	    key: 'handleAssignmentsTab',
	    value: function handleAssignmentsTab() {
	    ...
	    value: function handleTabs() {
	      ...
	      if (this.state.tabView === 'Assignments') {
	        view = _react2.default.createElement(_AssignmentsTab2.default, { assignments: this.props.currentCourse.assignments });
	      } else if (this.state.tabView === 'Students') {
	        view = _react2.default.createElement(_AllStudentsTab2.default, {
	          students: this.props.currentCourse.students,
	          handleStudent: this.handleStudent.bind(this)
	        });
	      } else if (this.state.tabView === 'Student') {
	        view = _react2.default.createElement(_Student2.default, {
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            { className: 'nav-item', onClick: function onClick() {
	                return _this2.handleAssignmentsTab();
	              } },
	            _react2.default.createElement(
	              'a',
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              'a',
	              {
	                ...
	                role: 'tab',
	                onClick: function onClick() {
	                  return _this2.handleAllStudentsTab();
	                }
	              },
	              'Students'
	            )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AllStudentsTab = function AllStudentsTab(_ref) {
	  var students = _ref.students;
	  var handleStudent = _ref.handleStudent;

	  var allStudents = students.map(function (student) {
	    return _react2.default.createElement(
	      "div",
	      { className: "card", onClick: function onClick() {
	          return handleStudent(student);
	        } },
	      _react2.default.createElement(
	        "div",
	...
	AllStudentsTab.propTypes = {
	  students: _react2.default.PropTypes.array,
	  handleStudent: _react2.default.PropTypes.func
	};

	exports.default = AllStudentsTab;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AssignmentsTab = function AssignmentsTab(_ref) {
	  var assignments = _ref.assignments;

	  var coursework = assignments.map(function (assignment) {
	    return _react2.default.createElement(
	      "div",
	      { className: "card" },
	      _react2.default.createElement(
	...
	AssignmentsTab.propTypes = {
	  assignments: _react2.default.PropTypes.array
	};

	exports.default = AssignmentsTab;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var StudentTab = function StudentTab(_ref) {
	  var student = _ref.student;
	  var handleBackButton = _ref.handleBackButton;
	  return _react2.default.createElement(
	    "div",
	    { className: "row" },
	    _react2.default.createElement(
	...
	StudentTab.propTypes = {
	  student: _react2.default.PropTypes.any,
	  handleBackButton: _react2.default.PropTypes.func
	};

	exports.default = StudentTab;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function instantiateChild(childInstances, child, name) {
	  ...
	  if (true) {
	     true ? warning(keyUnique, 'flattenChildren(...): Encountered two children with the same key, ' + '`%s`. Child keys must be unique; when two children share a key, only ' + 'the first child will be used.', name) : void 0;
	  }
